...
public class UserController : ControllerBase
{
  ...
  {
    if(newMaintenanceOperator == null || newMaintenanceOperator.Name == null || newMaintenanceOperator.LastName == null || newMaintenanceOperator.Email == null || newMaintenanceOperator.Building == null)
    {
      return BadRequest();
    }
